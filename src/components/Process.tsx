...
export function Process() {
  ...
  return (
    <section ref={container} id="processos" className="py-20 h-screen bg-black relative overflow-hidden border-t border-white/5 flex flex-col justify-center">
          ...
          <div ref={deck} className="relative w-full max-w-md lg:max-w-lg h-[350px] md:h-[400px]">
            {steps.map((step) => {
              return (
                ...
                >
                  <div className="w-full h-full bg-zinc-950 border border-white/10 relative overflow-hidden rounded-3xl shadow-2xl transition-all duration-300 flex flex-col justify-end group">
