...
export function Process() {
  ...
  return (
    <div className="bg-black">
      <section ref={container} id="processos" className="py-10 md:py-20 min-h-[100vh] bg-transparent relative overflow-hidden border-t border-white/5 flex flex-col justify-center">
