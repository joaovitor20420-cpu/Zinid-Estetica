...
export function Location() {
  return (
    <section id="contato" data-bgcolor="#000000" className="py-16 md:py-32 bg-transparent relative overflow-hidden">
      {/* Background Glows */}
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        >
          {/* Information Side */}
          <div className="p-8 md:p-10 lg:p-20 flex-1 flex flex-col justify-center relative z-20">
            ...
            <motion.h2 
              ...
              className="text-3xl md:text-5xl font-bold tracking-tighter mb-10 md:mb-16 text-white"
            >
          ...
          {/* Map Side */}
          <div className="lg:w-5/12 relative border-t lg:border-t-0 lg:border-l border-white/5 min-h-[300px] md:min-h-[400px] bg-[#050505] group overflow-hidden">
            <iframe 
